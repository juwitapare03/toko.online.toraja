...
<footer>
        <div class="row-flex  d-flex justify-content-around">
          <div class="tentang">
            <p>Toko Khas Oleh-Oleh Toraja <br>
               didirikan <br>
              pada tahun 2023
              <br>
              oleh: <br>
              Lionel Untung Lumika' <br>
              Juwita Pare <br>
              Kevin Pamasi Mangiwa <br>
          </div>
          <div class="toko">
            <p>Toko Oleh-Oleh <br>
              Khas Toraja bertempat <br>
              di
              Sulawesi Selatan, <br>
              Toraja Utara, <br>
              Indonesia <br>
              <br>
              Toko 1: Jln. Ahmad Yani <br>
              Toko 2: Kakondongan

          </div>
          <div class="tautan">
            <h4>Contact Person</h4>
            <p>Lionel: 082260115852
               <br>
               Juwita: 082123530364
              <br>
               Kevin: 082312562437</p>
          </div>
        </div>
      </footer>
